 ...
 * Description  :
 */
public class HomeHotWillPresenter extends BasePresenter {

    public HomeHotWillPresenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return apiService.getHomeWillData((int) args[0], (int) args[1]);
    }
}
